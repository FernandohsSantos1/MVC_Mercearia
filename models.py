#Arquivo para modelagem dos requisitos, definir atributos

#Importação da biblioteca para pegar data no momento da transação
from datetime import datetime


#Classes funcionario e cliente possuem caracteristicas em comum, por isso é interessante
#que classe possa herdar as caracteristicas de outra.
